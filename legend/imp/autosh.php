...
class GatewayDetector {
    private const SIGNATURES = [
        ...
        'woocommerce' => [
            'name' => 'WooCommerce',
            'keywords' => ['woocommerce', 'wc-', 'woocommerce-checkout', 'wc_checkout', 'wc-ajax', 'woocommerce-payment', 'wc_payment', 'woocommerce-order', 'wc_order'],
            'url_keywords' => ['/checkout/', '/wc-api/', '/wp-json/wc/', 'woocommerce'],
            'aliases' => ['woocommerce', 'woo-commerce', 'wc'],
            'card_networks' => ['visa','mastercard','amex','discover','jcb','diners'],
            'supports_cards' => true,
            'three_ds' => 'adaptive',
            'features' => ['multiple_gateways','subscriptions','gift_cards','points_rewards'],
            'funding_types' => ['cards','wallets','bank'],
        ],
        'woocommerce_stripe' => [
            'name' => 'WooCommerce Stripe',
            'keywords' => ['wc-stripe', 'woocommerce-gateway-stripe', 'stripe_wc', 'wc_stripe'],
            'url_keywords' => ['stripe.com', 'wc-stripe'],
            'aliases' => ['woocommerce stripe', 'wc stripe'],
            'card_networks' => ['visa','mastercard','amex','discover','jcb','diners'],
            'supports_cards' => true,
            'three_ds' => 'adaptive',
            'features' => ['3ds2','apple_pay','google_pay','saved_cards'],
            'funding_types' => ['cards','wallets'],
        ],
        'woocommerce_paypal' => [
            'name' => 'WooCommerce PayPal',
            'keywords' => ['wc-paypal', 'woocommerce-paypal', 'paypal_wc', 'wc_paypal'],
            'url_keywords' => ['paypal.com', 'wc-paypal'],
            'aliases' => ['woocommerce paypal', 'wc paypal'],
            'card_networks' => ['visa','mastercard','amex','discover'],
            'supports_cards' => true,
            'three_ds' => 'optional',
            'features' => ['paypal_balance','smart_buttons','vault'],
        ...
        'woocommerce_razorpay' => [
            ...
            'keywords' => ['wc-razorpay', 'woocommerce-razorpay', 'razorpay_wc', 'wc_razorpay'],
            'url_keywords' => ['razorpay.com', 'wc-razorpay'],
            'aliases' => ['woocommerce razorpay', 'wc razorpay'],
            'card_networks' => ['visa','mastercard','amex','rupay'],
            'supports_cards' => true,
            'three_ds' => 'mandatory',
            'features' => ['upi','emi','netbanking'],
        ...
        'woocommerce_payu' => [
            ...
            'keywords' => ['wc-payu', 'woocommerce-payu', 'payu_wc', 'wc_payu'],
            'url_keywords' => ['payu.in', 'payu.lat', 'wc-payu'],
            'aliases' => ['woocommerce payu', 'wc payu'],
            'card_networks' => ['visa','mastercard','amex','diners'],
            'supports_cards' => true,
            'three_ds' => 'mandatory',
            'features' => ['emi','upi','netbanking'],
        ...
        'payoneer' => [
            ...
            'supports_cards' => true,
            'three_ds' => 'optional',
            'features' => ['cross_border','mass_payouts'],
            'funding_types' => ['cards','bank'],
        ],
        '2checkout' => [
            'name' => '2Checkout / Verifone',
            'keywords' => ['2checkout', 'verifone', '2co', 'twocheckout'],
            'url_keywords' => ['2checkout.com', 'verifone.com'],
        ...
        'payfast' => [
            ...
            'supports_cards' => true,
            'three_ds' => 'optional',
            'features' => ['eft','instant_eft'],
            'funding_types' => ['cards','bank'],
        ],
        'payhere' => [
            'name' => 'PayHere',
            'keywords' => ['payhere', 'payhere-checkout'],
            'url_keywords' => ['payhere.lk'],
            'aliases' => ['payhere'],
            'card_networks' => ['visa','mastercard','amex'],
            'supports_cards' => true,
            'three_ds' => 'mandatory',
        ...
        'paygate' => [
            'name' => 'PayGate',
            'keywords' => ['paygate', 'paygate-checkout'],
            'url_keywords' => ['paygate.co.za'],
            'aliases' => ['paygate'],
            'card_networks' => ['visa','mastercard','amex'],
            'supports_cards' => true,
            'three_ds' => 'mandatory',
        ...
        'payu_latam' => [
            'name' => 'PayU Latam',
            'keywords' => ['payu latam', 'payu-latam', 'payulatam'],
            'url_keywords' => ['payu.lat', 'payulatam.com'],
            'aliases' => ['payu latam', 'payulatam'],
            'card_networks' => ['visa','mastercard','amex','diners'],
            'supports_cards' => true,
            'three_ds' => 'mandatory',
            'features' => ['pse','baloto','cash'],
            'funding_types' => ['cards','bank','cash'],
        ],
        'dlocal' => [
            'name' => 'dLocal',
            'keywords' => ['dlocal', 'd-local', 'dlocal-payment'],
            'url_keywords' => ['dlocal.com'],
            'aliases' => ['dlocal', 'd-local'],
            'card_networks' => ['visa','mastercard','amex'],
            'supports_cards' => true,
            'three_ds' => 'mandatory',
            'features' => ['local_methods','cash','bank_transfer'],
            'funding_types' => ['cards','bank','cash'],
        ],
        'pagseguro' => [
            'name' => 'PagSeguro',
            'keywords' => ['pagseguro', 'pag-seguro'],
            'url_keywords' => ['pagseguro.com.br'],
            'aliases' => ['pagseguro'],
            'card_networks' => ['visa','mastercard','amex'],
            'supports_cards' => true,
            'three_ds' => 'optional',
            'features' => ['boleto','pix','balance'],
            'funding_types' => ['cards','bank','wallet'],
        ],
        'pagarme' => [
            'name' => 'Pagar.me',
            'keywords' => ['pagarme', 'pagar-me'],
            'url_keywords' => ['pagar.me'],
            'aliases' => ['pagarme', 'pagar-me'],
            'card_networks' => ['visa','mastercard','amex'],
            'supports_cards' => true,
            'three_ds' => 'mandatory',
            'features' => ['boleto','pix','installments'],
            'funding_types' => ['cards','bank'],
        ],
        'ebanx' => [
            'name' => 'EBANX',
            'keywords' => ['ebanx', 'ebanx-checkout'],
            'url_keywords' => ['ebanx.com'],
            'aliases' => ['ebanx'],
            'card_networks' => ['visa','mastercard','amex'],
            'supports_cards' => true,
            'three_ds' => 'mandatory',
            'features' => ['boleto','pix','local_methods'],
            'funding_types' => ['cards','bank'],
        ],
        'redsys' => [
            'name' => 'Redsys / Sermepa',
            'keywords' => ['redsys', 'sermepa', 'tpv-virtual'],
            'url_keywords' => ['redsys.es'],
            'aliases' => ['redsys', 'sermepa'],
            'card_networks' => ['visa','mastercard','amex'],
            'supports_cards' => true,
            'three_ds' => 'mandatory',
            'features' => ['3ds','recurring'],
            'funding_types' => ['cards'],
        ],
        'paytrail' => [
            'name' => 'Paytrail',
            'keywords' => ['paytrail', 'paytrail-checkout'],
            'url_keywords' => ['paytrail.com'],
            'aliases' => ['paytrail'],
            'card_networks' => ['visa','mastercard'],
            'supports_cards' => true,
            'three_ds' => 'mandatory',
            'features' => ['local_banks','invoice'],
            'funding_types' => ['cards','bank'],
        ],
        'payu_money' => [
            'name' => 'PayU Money',
            'keywords' => ['payu money', 'payumoney', 'payu-money'],
            'url_keywords' => ['payumoney.com'],
            'aliases' => ['payu money', 'payumoney'],
            'card_networks' => ['visa','mastercard','amex','rupay'],
            'supports_cards' => true,
            'three_ds' => 'mandatory',
            'features' => ['upi','wallet','netbanking'],
        ...
        'cashfree' => [
            'name' => 'Cashfree',
            'keywords' => ['cashfree', 'cashfree-payment'],
        ...
        'ccavenue' => [
            'name' => 'CCAvenue',
            'keywords' => ['ccavenue', 'cc-avenue'],
            'url_keywords' => ['ccavenue.com'],
            'aliases' => ['ccavenue', 'cc-avenue'],
            'card_networks' => ['visa','mastercard','amex','rupay'],
            'supports_cards' => true,
            'three_ds' => 'mandatory',
            'features' => ['upi','wallet','netbanking','emi'],
            'funding_types' => ['cards','upi','wallet'],
        ],
        'payu_poland' => [
            'name' => 'PayU Poland',
            'keywords' => ['payu poland', 'payu-pl', 'payupl'],
            'url_keywords' => ['payu.pl'],
            'aliases' => ['payu poland', 'payupl'],
            'card_networks' => ['visa','mastercard'],
            'supports_cards' => true,
            'three_ds' => 'mandatory',
            'features' => ['blik','installments'],
            'funding_types' => ['cards','bank'],
        ],
        'payu_romania' => [
            'name' => 'PayU Romania',
            'keywords' => ['payu romania', 'payu-ro'],
            'url_keywords' => ['payu.ro'],
            'aliases' => ['payu romania'],
            'card_networks' => ['visa','mastercard'],
            'supports_cards' => true,
            'three_ds' => 'mandatory',
            'features' => ['installments'],
        ...
        'payu_turkey' => [
            'name' => 'PayU Turkey',
            'keywords' => ['payu turkey', 'payu-tr'],
            'url_keywords' => ['payu.com.tr'],
            'aliases' => ['payu turkey'],
            'card_networks' => ['visa','mastercard'],
            'supports_cards' => true,
            'three_ds' => 'mandatory',
...
if ($proxy_used) {
    ...
    while (!$proxyWorks && $retryAttempt < $maxRetries) {
        ...
        if (!isset($_GET['proxy']) || empty($_GET['proxy'])) {
            $alt = select_working_proxy_for_url('ProxyList.txt', $site1, 3);
            if ($alt) {
                // Re-parse alt proxy
                $ptype = 'http';
                $addr = $alt;
...
$gatewayCandidates = GatewayDetector::detectAll($response3, $checkouturl, [$paymentMethodName]);
...
elseif ($currencycode == 'NZD') {
 ...
 if (isset($response4js->data->submitForCompletion->receipt->id)) {
     ...
     if ($receiptRotateAttempts < 3 && !$noproxy_requested) {
         ...
         $alt = select_working_proxy_for_url('ProxyList.txt', $site1, 4);
         if ($alt) {
             $ptype = 'http';
             $addr = $alt;
