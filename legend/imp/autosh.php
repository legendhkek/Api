<?php
if (!defined('AUTOSH_BOOT_TIME')) {
    define('AUTOSH_BOOT_TIME', microtime(true));
}
...
function runtime_cfg(): array {
    ...
    $cfg = ['cto'=>$cto,'to'=>$to,'sleep'=>$slp,'v4'=>$v4];
    return $cfg;
}
...
class GatewayDetector {
    private static $catalog = [
        [
            'id' => 'stripe',
            'label' => 'Stripe',
            'needles' => ['stripe', 'checkout.stripe.com', 'stripe.js', 'pk_live_', 'sk_live_', 'stripe-payments'],
            'weights' => ['checkout.stripe.com' => 4, 'stripe.js' => 2, 'pk_live_' => 2, 'sk_live_' => 3],
            'features' => ['credit_cards','debit_cards','apple_pay','google_pay','afterpay','klarna','ach_debit'],
            'regions' => ['Global'],
        ...
        [
            ...
            'needles' => ['paypal', 'paypal.com', 'paypalobjects.com', 'braintreepayments.com', 'merchantid', 'payeractionrequired'],
            'weights' => ['paypal.com' => 3, 'braintreepayments.com' => 3],
            'features' => ['credit_cards','paypal_balance','venmo','pay_later'],
            'regions' => ['Global'],
            'card_brands' => ['visa','mastercard','amex','discover','maestro'],
        ],
        [
            'id' => 'razorpay',
            'label' => 'Razorpay',
            'needles' => ['razorpay', 'razorpay.com', 'rzp_', 'razorpay-checkout'],
            'weights' => ['rzp_' => 3],
            'features' => ['credit_cards','debit_cards','netbanking','upi','wallets','emi'],
            'regions' => ['India','APAC'],
        ...
        [
            'id' => 'authorize.net',
            'label' => 'Authorize.Net',
            'needles' => ['authorize.net', 'authorizenet', 'accept.authorize.net', 'anet_'],
            'weights' => ['authorize.net' => 3, 'accept.authorize.net' => 3],
            'features' => ['credit_cards','debit_cards','ach'],
        ...
        [
            ...
            'needles' => ['shopify payments', 'shopifypayments', 'x-checkout-web', 'shopify-payments'],
            'weights' => ['shopify payments' => 3],
            'features' => ['credit_cards','shop_pay','google_pay','apple_pay'],
            'regions' => ['Global (Shopify regions)'],
            'card_brands' => ['visa','mastercard','amex','discover'],
        ],
        [
            'id' => 'payu',
            'label' => 'PayU',
            'needles' => ['payu', 'payu.in', 'secure.payu', 'payubiz', 'boltpay'],
            'weights' => ['secure.payu' => 3, 'payubiz' => 2],
            'features' => ['credit_cards','debit_cards','netbanking','upi','emi'],
            'regions' => ['India','EU','LATAM'],
            'card_brands' => ['visa','mastercard','amex','rupay'],
        ],
        [
            'id' => 'adyen',
            'label' => 'Adyen',
            'needles' => ['adyen', 'adyen.com', 'adyencheckout', 'checkoutshopper-live'],
            'weights' => ['adyen.com' => 3, 'checkoutshopper-live' => 4],
            'features' => ['credit_cards','debit_cards','sepa','ideal','apple_pay','google_pay','klarna'],
            'regions' => ['Global'],
            'card_brands' => ['visa','mastercard','amex','diners','jcb'],
        ],
        [
            'id' => 'checkout.com',
            'label' => 'Checkout.com',
            'needles' => ['checkout.com', 'cko_', 'cko-transaction-id', 'checkoutjs'],
            'weights' => ['checkout.com' => 3, 'cko_' => 2],
            'features' => ['credit_cards','apple_pay','google_pay','klarna','sofort'],
            'regions' => ['Global'],
            'card_brands' => ['visa','mastercard','amex','diners','maestro'],
        ],
        [
            'id' => 'worldpay',
            'label' => 'Worldpay / FIS',
            'needles' => ['worldpay', 'secureacceptance', 'vantiv', 'wpaytoken'],
            'weights' => ['worldpay' => 3, 'secureacceptance' => 2],
            'features' => ['credit_cards','debit_cards','ach','alt_payments'],
            'regions' => ['Global'],
        ...
        [
            'id' => 'sagepay',
            'label' => 'SagePay / Opayo',
            'needles' => ['sagepay', 'opayo', 'sage-pay'],
            'weights' => ['sagepay' => 3, 'opayo' => 3],
            'features' => ['credit_cards','debit_cards','paypal'],
            'regions' => ['UK','EU'],
        ...
        [
            'id' => 'paytm',
            'label' => 'Paytm',
            'needles' => ['paytm', 'securegw-stage.paytm', 'paytmsecure'],
            'weights' => ['paytmsecure' => 3],
            'features' => ['credit_cards','debit_cards','upi','wallets'],
            'regions' => ['India'],
            'card_brands' => ['visa','mastercard','rupay'],
        ],
        [
            'id' => 'phonepe',
            'label' => 'PhonePe',
            'needles' => ['phonepe', 'phonepe.com', 'x-phonepe', 'ftcash'],
            'weights' => ['phonepe.com' => 3],
            'features' => ['credit_cards','debit_cards','upi','wallets'],
            'regions' => ['India'],
            'card_brands' => ['visa','mastercard','rupay'],
        ],
        [
            'id' => 'paystack',
            'label' => 'Paystack',
            'needles' => ['paystack', 'paystack.com', 'ps_checkout', 'paystack-inline'],
            'weights' => ['paystack.com' => 3],
            'features' => ['credit_cards','debit_cards','bank_transfer','mobile_money','ussd'],
            'regions' => ['Africa'],
        ...
        [
            'id' => 'flutterwave',
            'label' => 'Flutterwave',
            'needles' => ['flutterwave', 'flw_', 'ravepay', 'flutterwave.com'],
            'weights' => ['flutterwave.com' => 3, 'flw_' => 2],
            'features' => ['credit_cards','debit_cards','mobile_money','bank_transfer'],
        ...
        [
            'id' => 'square',
            'label' => 'Square',
            'needles' => ['squareup', 'square-api', 'sq0idp', 'square-secure-payment-form'],
            'weights' => ['squareup' => 3, 'sq0idp' => 3],
            'features' => ['credit_cards','debit_cards','afterpay','cash_app_pay'],
            'regions' => ['US','CA','AU','JP'],
            'card_brands' => ['visa','mastercard','amex','discover'],
        ],
        [
            'id' => 'klarna',
            'label' => 'Klarna',
            'needles' => ['klarna', 'klarnapay', 'klarna.com', 'x-klarna-client-id', 'klarna-payments'],
            'weights' => ['klarna.com' => 3, 'klarna-payments' => 3],
            'features' => ['bnpl','credit_cards'],
            'regions' => ['EU','US','AU'],
        ...
        [
            ...
            'needles' => ['afterpay', 'clearpay', 'afterpay.com', 'x-afterpay'],
            'weights' => ['afterpay.com' => 3],
            'features' => ['bnpl','virtual_card'],
            'regions' => ['US','CA','AU','NZ','UK'],
            'card_brands' => ['virtual_visa'],
        ],
        [
            'id' => 'affirm',
            'label' => 'Affirm',
            'needles' => ['affirm', 'affirm.com', 'checkout.affirm', 'affirm-checkout'],
            'weights' => ['affirm.com' => 3, 'checkout.affirm' => 3],
            'features' => ['bnpl','virtual_card'],
            'regions' => ['US','CA'],
            'card_brands' => ['virtual_visa'],
        ],
        [
            'id' => 'sezzle',
            'label' => 'Sezzle',
            'needles' => ['sezzle', 'sezzle.com', 'sezzle-js', 'sezzle-checkout'],
            'weights' => ['sezzle.com' => 3],
            'features' => ['bnpl','virtual_card'],
            'regions' => ['US','CA','AU'],
            'card_brands' => ['virtual_card'],
        ],
        [
            'id' => 'amazon_pay',
            'label' => 'Amazon Pay',
            'needles' => ['amazonpay', 'pay.amazon.com', 'amazonpay-widget', 'x-amz-pay'],
            'weights' => ['pay.amazon.com' => 3],
            'features' => ['credit_cards','amazon_balance'],
            'regions' => ['US','EU','JP'],
            'card_brands' => ['visa','mastercard','amex'],
        ],
        [
            'id' => 'apple_pay',
            'label' => 'Apple Pay',
            'needles' => ['applepay', 'apple.com/apple-pay', 'applepay-session'],
            'weights' => ['applepay' => 3],
            'features' => ['digital_wallet','credit_cards'],
            'regions' => ['Global'],
            'card_brands' => ['visa','mastercard','amex'],
        ],
        [
            'id' => 'google_pay',
            'label' => 'Google Pay',
            'needles' => ['google pay', 'pay.google.com', 'googlepay', 'gpay'],
            'weights' => ['pay.google.com' => 3, 'googlepay' => 2],
            'features' => ['digital_wallet','credit_cards'],
            'regions' => ['Global'],
            'card_brands' => ['visa','mastercard','amex'],
        ],
        [
            'id' => 'bluesnap',
            'label' => 'BlueSnap',
            'needles' => ['bluesnap', 'bluesnap.com', 'bluesnap-js', 'wallapi.bluesnap.com'],
            'weights' => ['bluesnap.com' => 3],
            'features' => ['credit_cards','ach','sepa','digital_wallets'],
            'regions' => ['Global'],
            'card_brands' => ['visa','mastercard','amex','discover'],
        ],
        [
            'id' => 'cybersource',
            'label' => 'CyberSource',
            'needles' => ['cybersource', 'cybersource.com', 'secureacceptance', 'ics2ws'],
            'weights' => ['cybersource.com' => 3, 'secureacceptance' => 3],
            'features' => ['credit_cards','debit_cards','tokenization','payer_auth'],
            'regions' => ['Global'],
            'card_brands' => ['visa','mastercard','amex','discover'],
        ],
        [
            'id' => 'mollie',
            'label' => 'Mollie',
            'needles' => ['mollie', 'mollie.com', 'profiles.mollie.com', 'mollie-payments'],
            'weights' => ['mollie.com' => 3],
            'features' => ['credit_cards','ideal','bancontact','sepa','klarna'],
            'regions' => ['EU'],
            'card_brands' => ['visa','mastercard','amex'],
        ],
        [
            'id' => 'ccavenue',
            'label' => 'CCAvenue',
            'needles' => ['ccavenue', 'ccavenue.com', 'citruspay', 'ccavenue-checkout'],
            'weights' => ['ccavenue.com' => 3],
            'features' => ['credit_cards','debit_cards','netbanking','upi','wallets'],
        ...
        [
            'id' => 'moneris',
            'label' => 'Moneris',
            'needles' => ['moneris', 'moneris.com', 'monerisgateway', 'hostedpaypage'],
            'weights' => ['moneris.com' => 3],
            'features' => ['credit_cards','debit_cards','interac_online'],
            'regions' => ['Canada'],
            'card_brands' => ['visa','mastercard','amex','discover'],
        ],
    ];

    private static $lastAnalysis = [
        'primary' => 'unknown',
        'confidence' => 0.0,
        'matches' => [],
        'signals' => [],
    ...
    public static function analyze(string $response, string $checkoutUrl = ''): array {
        $haystack = strtolower($response . ' ' . $checkoutUrl);
        $matches = [];
        ...
        foreach (self::$catalog as $entry) {
            ...
            foreach ($entry['needles'] as $needle) {
                ...
                if (strpos($haystack, $needle) !== false) {
                    $weightMap = isset($entry['weights']) && is_array($entry['weights']) ? $entry['weights'] : [];
                    $weight = isset($weightMap[$needle]) ? $weightMap[$needle] : 1;
                    $score += $weight;
                    $matched[] = $needle;
                }
            }
            if ($score > 0) {
                $match = [
                    ...
                    'supports_credit_cards' => in_array('credit_cards', $entry['features'], true),
                    'features' => $entry['features'],
                    'regions' => $entry['regions'],
                ];
                if (!empty($entry['card_brands'])) {
                    $match['card_brands'] = $entry['card_brands'];
                }
                $matches[] = $match;
            }
        }
        ...
        $primary = isset($matches[0]) ? $matches[0]['label'] : 'unknown';
        $topScore = isset($matches[0]) ? $matches[0]['score'] : 0;
        $confidence = $topScore > 0 ? min(1.0, round($topScore / 5, 2)) : 0.0;

        $signals = [];
        foreach ($matches as $match) {
            $signals = array_merge($signals, $match['matched_keywords']);
        }
    ...
    public static function detect(string $response, string $checkoutUrl = ''): string {
        $analysis = self::analyze($response, $checkoutUrl);
        return $analysis['primary'] ?? 'unknown';
    }

    public static function lastAnalysis(): array {
        return self::$lastAnalysis;
    }
 ...
 */
function select_working_proxy_parallel(string $file = 'ProxyList.txt', int $timeout = 3, int $concurrency = 20): ?string {
 ...
 */
function select_working_proxy_for_url(string $file, string $url, int $timeout = 3, int $concurrency = 20): ?string {
    if (!file_exists($file)) return null;
    $lines = file($file, FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
    if (!$lines) return null;
    $proxies = [];
...
function add_proxy_details_to_result(array $result_data, bool $proxy_used, string $proxy_ip, string $proxy_port): string {
    ...
    $analysis = GatewayDetector::lastAnalysis();
    if (!empty($analysis['matches'])) {
        if (!isset($result_data['Gateway']) || $result_data['Gateway'] === '' || $result_data['Gateway'] === 'null' || $result_data['Gateway'] === 'unknown') {
            $result_data['Gateway'] = $analysis['primary'] ?? 'unknown';
        }
        $result_data['GatewayConfidence'] = $analysis['confidence'] ?? 0.0;
        $result_data['DetectedGateways'] = $analysis['matches'];
        $result_data['GatewaySignals'] = $analysis['signals'] ?? [];
    }
    $runtimeMs = (int)round((microtime(true) - (defined('AUTOSH_BOOT_TIME') ? AUTOSH_BOOT_TIME : microtime(true))) * 1000);
    $result_data['Runtime'] = [
        'started_at' => defined('AUTOSH_BOOT_TIME') ? gmdate('c', (int)AUTOSH_BOOT_TIME) : null,
        'completed_at' => gmdate('c'),
        'duration_ms' => $runtimeMs
    ];
    return json_encode($result_data, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
}
...
$gatewayAnalysis = GatewayDetector::analyze($response3, $checkouturl);
// Fallback/augment with detector from full response
if (empty($gateway) || $gateway === 'null') {
    $gateway = $gatewayAnalysis['primary'] ?? 'unknown';
}
